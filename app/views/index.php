	...
	<div id="fh5co-page">
        ...
        <div id="fh5co-board" data-columns>
			...
			<div class="item">
					    ...
					    <div class="container">
					    	<div class="row">
					    		<div class="col-md-8 col-md-offset-2 fh5co-section-heading text-center">
									...
									<p class="fh5co-sub to-animate">Offerciti Brings the best local market offers around your city in your favourite stores. Now find every discount and sales information which is available in the local market.</p>
								</div>
					    		<div class="col-md-4 fh5co-text-wrap">
					    			<div class="row text-center">
						    			<div class="col-md-12 col-sm-6 col-xs-12 fh5co-text animate-object features-2-animate-3">
						    				<span class="fh5co-icon"><i class="fa fa-fw fa-share-alt"></i></span>
											<h4 class="fh5co-uppercase-sm">Offer Sharing</h4>
											<p>Offerciti Brings the best local market offers around your city in your favourite stores. Now find every discount and sales information which is available in the local market.</p>
										</div>
										<div class="col-md-12 col-sm-6 col-xs-12 fh5co-text animate-object features-2-animate-4">
					    		...
					    		<div class="col-md-4 col-md-push-4 fh5co-text-wrap">
					    			<div class="row text-center">
						    			<div class="col-md-12 col-sm-6 col-xs-12 fh5co-text animate-object features-2-animate-5">
						    				<span class="fh5co-icon"><i class="fa fa-fw fa-heart"></i></span>
											<h4 class="fh5co-uppercase-sm">Ratings and Reviews</h4>
											<p>Offerciti Brings the best local market offers around your city in your favourite stores. Now find every discount and sales information which is available in the local market.</p>
										</div>
										<div class="col-md-12 col-sm-6 col-xs-12 fh5co-text animate-object features-2-animate-6">
					    		...
					    		<div class="col-md-4 col-md-pull-4 fh5co-image animate-object features-2-animate-2">
					    			<p class="text-center">
					    			<img src="<?php echo site_url('app/assets/images/iphone_blank_2.png');?>" class="" alt="Outline Free HTML5 Responsive Bootstrap Template">
					    			</p>
					    		</div>
				...
				<div id="fh5co-counter" class="fh5co-bg-section animated" style="background-image: url(assets/images/hm-ad-bg.png); background-attachment: fixed;">
								...
								<div class="fh5co-hero-wrap">
									<div class="fh5co-hero-intro text-center to-animate counter-animate">
									  <div class="col-md-3 text-center">
											<span class="fh5co-counter js-counter" data-from="0" data-to="100864" data-speed="5000" data-refresh-interval="50"></span>
											<span class="fh5co-counter-label">Offers</span>
											
										</div>
										<div class="col-md-3 text-center">
											<span class="fh5co-counter js-counter" data-from="0" data-to="86864" data-speed="5000" data-refresh-interval="50"></span>
											<span class="fh5co-counter-label">Customers</span>
											
										</div>
										<div class="col-md-3 text-center">
											<span class="fh5co-counter js-counter" data-from="0" data-to="1453" data-speed="5000" data-refresh-interval="50"></span>
											<span class="fh5co-counter-label">Stores</span>
										</div>
										<div class="col-md-3 text-center">
											<span class="fh5co-counter js-counter" data-from="0" data-to="34026" data-speed="5000" data-refresh-interval="50"></span>
