                        ...
                        <div class="post-advertise-info">
                           ...
                           <div class="select-offers-sub-category">
                              <div class="form-group col-xs-12 select-ofr-lbl">
                                 <label for="offer-title" class="control-label">*Enter The Offers</label>
                              </div>
                              <section class="select-offers-sub-category-wrap">
                                 <div class="ac ac-lvl-1">
                                    <input class="ac-input" id="ac-1" name="ac-1" type="checkbox" />
                                    <label class="ac-label  ac-lbl-lvl-1" for="ac-1">
                                    <span class="input-blue checkbox">
                                    <input type="checkbox" id="clothing">
                                    <label for="clothing">Clothing<span class="ofr-perc-lbl">30%</span></label>
                                    </span>
                                    </label>
                                    <article class="ac-sub-cat-lvl-2">
                                       <div class="ac-sub">
                                          <input class="ac-input" id="ac-2" name="ac-2" type="checkbox" />
                                          <label class="ac-label ac-lbl-lvl-2" for="ac-2">
                                          <span class="input-blue checkbox">
                                          <input type="checkbox" id="men">
                                          <label for="men">Men<span class="ofr-perc-lbl">30%</span></label>
                                          </span>
                                          </label>
                                          <article class="ac-sub-cat-lvl-3">
									...
									<article class="ac-sub-cat-lvl-2">
                                       <div class="ac-sub">
                                          ...
                                          <label class="ac-label ac-lbl-lvl-2" for="ac-3">
                                          <span class="input-blue checkbox">
                                          <input type="checkbox" id="women">
                                          <label for="women">Women<span class="ofr-perc-lbl">30%</span></label>
                                          </span>
                                          </label>
                                          <article class="ac-sub-cat-lvl-3">
                                             <div class="section-inputs">
                                                ...
                                                <label for="Sarees">Sarees<span class="ofr-perc-lbl">30%</span></label>
                                                </span>
                                                <span class="input-blue checkbox">
                                                <input type="checkbox" id="checkbox2">
                                                <label for="checkbox2">Chudidar</label>
                                                </span>
                                                <span class="input-blue checkbox">
                                                <input type="checkbox" id="checkbox3">
                                                <label for="checkbox3">Jeans<span class="ofr-perc-lbl">30%</span></label>
