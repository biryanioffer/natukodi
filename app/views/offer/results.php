    ...
    <div class="row resutls-cont">
        ...
        <div id="left-nav" class="col-md-3">
            ...
            <form id="oc-filter" class="form-prd-srch">
                ...
                <div id="sel-category-filter" class="scroll-pane sel-category-filter"
                     style="overflow: hidden; padding: 0px; width: 227px;">

                    <div class="jspContainer" style="width: 227px; height: 54px;">
                ...
                <div class="area-fltr-wrap">
                    <select id="maxOption2" class="selectpicker  form-control" multiple data-live-search="true"
                            data-max-options="3" title="Area">
                ...
                <div class="row store-feat">
                    ...
                    <div class="col-md-10 rating-feat-wrap store-feat-more-wrap">
                        <ul class="list-inline">
                            ...
                            <li>
                                <div class="vendor-lbl"><a href="more_details" class="btn btn-primary btn-xs"
                                                           data-toggle="tooltip" data-placement="bottom"
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 vendor-card">
                        <div class="thumbnail">
                            ...
                            <img src="<?php echo site_url('app/assets/images/vendor-assets/rsbrothers.jpg'); ?>"
                                 alt="Chandana Brothers" title="Chandana Brothers">
                        </div>
                    </div>
                    <div class="col-md-10 vendor-info-wrap">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 vendor-card">
                        <div class="thumbnail">
                            ...
                            <img src="<?php echo site_url('app/assets/images/vendor-assets/nallisilks.jpg'); ?>"
                                 alt="Nalli Silks" title="Nalli Silks">
                        </div>
                    </div>
                    <div class="col-md-10 vendor-info-wrap">
                        <ul class="list-inline">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 vendor-card">
                        <div class="thumbnail">
                            ...
                            <img src="<?php echo site_url('app/assets/images/vendor-assets/zari.jpg'); ?>"
                                 alt="Zari Sarees" title="Zari Sarees">
                        </div>
                    </div>
                    <div class="col-md-10 vendor-info-wrap">
                        <ul class="list-inline">
