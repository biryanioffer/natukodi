                        ...
                        <div class="panel panel-default">
                           ...
                           <div id="collapse1" class="panel-collapse collapse in">
                              <div class="panel-body">
                                  <div class="row">
                                    <div class="col-sm-2">										
                                       <a id="" href="../merchant/profile.php" class="btn btn-theme btn-theme-block"><span class="glyphicon glyphicon-user"></span>Profile </a>
                                    </div>
                                    <div class="col-sm-2">
                                       <a id="" href="../merchant/posts.php" class="btn btn-theme btn-theme-block"><span class="glyphicon glyphicon-tag"></span>Manage Ads</a>
                                    </div>
                                    <div class="col-sm-2">
                                       <a id="" href="../merchant/wallet.php" class="btn btn-theme btn-theme-block"><span class="glyphicon glyphicon-briefcase"></span>Wallet</a>
                                    </div>
                                    <div class="col-sm-2">
                                       <a id="" href="../merchant/branches.php" class="btn btn-theme btn-theme-block"><span class="glyphicon glyphicon-home"></span>Branches</a>
                                    </div>
									<div class="col-sm-2">
										<a id="" href="postad.php" class="btn btn-theme-dark btn-theme-dark"><span class="glyphicon glyphicon-bullhorn"></span>Post Ad </a>
									</div>
									<div class="col-sm-2">
                                       <a id="" href="../merchant/changePassword.php" class="btn btn-theme btn-theme-block"><span class="glyphicon glyphicon-lock"></span>Change Password</a>
                                    </div>
                                    <div class="col-sm-2">
                                       <a id="" href="../merchant/notifications.php" class="btn btn-theme btn-theme-block"><span class="glyphicon glyphicon-bell"></span>Notifications</a>
                                    </div>
                                    <div class="col-sm-2">
                                       <a id="" href="../merchant/support.php" class="btn btn-theme btn-theme-block"><span class="glyphicon glyphicon-envelope"></span>Support</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     <fieldset class="post-free-advertiser-biz-info" id="post-free-advertiser-biz-info">
                        <div class="post-advertise-info">
                           ...
                           <div class="form-group">
                              <label for="offer-title" for="pin-code" class="col-md-4 control-label">Offer Title</label>
                              <div class="col-md-6">								
                                 <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Enter your Offer Title  EX: Flat 30% on Summer SALE or Upto 60% on Designer Sarees" id="offer-title" placeholder="Offer Title">																
                              </div>
                           </div>
                           <div class="form-group">
                              <label for="abt-offer" for="pin-code" class="col-md-4 control-label">*About Your Offer</label>
                              <div class="col-md-6">								
                                 <textarea class="form-control" rows="3" id="abt-offer" data-toggle="tooltip" data-placement="bottom" title="Ex: 30% offer on sarees, formal shirts, Jeans, kids frogs">Describe about your offer</textarea>
                              </div>
                           </div>
                           <div class="form-group">
                              <label for="offer-start-date" class="col-md-4 control-label">*Offer Start Date</label>
                              <div class="col-md-4">
                                 <input type="text" placeholder="*Offer Start Date" id="start-date" class="form-control date-pic">
                              </div>
                           </div>
                           <div class="form-group">
                              <label for="offer-end-date" class="col-md-4 control-label">*Offer End Date</label>
                              <div class="col-md-4">
                                 <input type="text" placeholder="*Offer End Date" id="end-date" class="form-control date-pic">
                              </div>
                           </div>
                           <div class="form-group">
                              <label for="state" for="pin-code" class="col-md-4 control-label">*Select Offers Category</label>
                              <div class="col-md-6">
                           ...
                           <div class="select-offers-sub-category">
                              <div class="form-group col-xs-12 select-ofr-lbl">
                                 <label for="offer-title" class="control-label">*select Offers Sub Category</label>
                              </div>
						   ...
						   <div class="row">
                              <div class="form-group col-xs-12 select-ofr-lbl">
                                 <label for="offer-title" for="pin-code" class="control-label">*select Offer</label>
                              </div>
							   <div class="row">
										...
										<div class="col-xs-3">
											...
											<div class="flat-metrics">
												<span class="flat-metrics-inr">
													<input type="text" class="form-control sel-ofr-tf" data-toggle="tooltip" data-placement="bottom" title="10" id="offer-title" placeholder="10">
												</span>
												<span class="flat-metrics-inr">
													<select id="sel1" class="selectpicker sel-ofr-pkr" data-live-search="true"  title="% Off">
										...
										<div class="col-xs-3">
											...
											<div class="buyofr-metrics">
												<div class="form-inline">
													<select id="sel1" class="selectpicker" data-live-search="true"  title="Buy 1">
													   <option>1</option>
													   <option>2</option>
													   <option>3</option>
													   <option>4</option>
													</select>
													<select id="buy" class="selectpicker" data-live-search="true"  title="Get 1">
													   <option>1</option>
													   <option>2</option>
													   <option>3</option>
													   <option>4</option>
                           ...
                           <div class="form-inline gallery-images">
						    ...
						    <div class="form-group">
						     ...
						     <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 <select id="maxOption2" class="selectpicker  form-control" multiple data-live-search="true" data-max-options="50">
