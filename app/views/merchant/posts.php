            ...
            <div id="store-ac-wrap-inner" style="margin-top:50px;" class="mainbox  col-md-10 col-md-offset-1">
                           ...
                           <div id="collapse1" class="panel-collapse collapse in">
                              <div class="panel-body">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                       <a id="" href="#" class="btn btn-theme-dark btn-theme-dark"><span class="glyphicon glyphicon-tag"></span>Manage Ads</a>
                                    </div>
                                    <div class="col-sm-2">
               ...
               <div class="panel panel-info">
                  ...
                  <div class="panel-body">
                     ...
                     <div class="row">
                        <div class="col-sm-3">										
                           <input type="text" placeholder="Ads From Date" id="start-date" class="form-control date-pic hasDatepicker">
                        </div>
                        <div class="col-sm-3">
                           <input type="text" placeholder="Ads To Date" id="end-date" class="form-control date-pic hasDatepicker">
                        </div>
                        ...
                        <div class="col-sm-4" style="padding-right: 0px;">
                           <div class="ad-search-cont">
                              <input type="text" class="form-control" id="search" placeholder="Search Offer Code / category / location">
                              <button  class="btn btn-success btn-sm"><span class="glyphicon glyphicon-search"></span></button></span>
                           </div>
                        </div>
                     </div>
                        ...
                        <table class="table table-hover table-responsive myads-tble">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                    <ul class="features">
                                       <li><span class="val-start-date">01-01-2016</span> to <span class="val-expire-date">01-07-2016</span></li>
                                    </ul>
                                 </td>
                                 <td>Pending</td>
                                 <td>01-10-2015</td>
                                 <td>
                                    <button class="btn btn-default btn-sm stats-btn" data-toggle="tooltip" data-placement="bottom" title="Statistics">
                                    <span class="glyphicon glyphicon-equalizer"></span>
                                    </button>
                                    <button class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="View">
                                    <span class="glyphicon glyphicon-eye-open"></span>
                                    </button>
                                    <button class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit">
                                    <span class="glyphicon glyphicon-edit"></span>
                                    </button>
                                    <button class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="bottom" title="Duplicate">
                              ...
                              <tr>
                                 ...
                                 <td>01-10-2015</td>
                                 <td>
                                    <button class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="Statistics">
                                    <span class="glyphicon glyphicon-equalizer"></span>
                                    </button>
                                    <button class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="View">
                                    <span class="glyphicon glyphicon-eye-open"></span>
