...
<title>Offerciti | Store Wallet</title>
                           ...
                           <div id="collapse1" class="panel-collapse collapse in">
                              <div class="panel-body">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                       <a id="" href="#" class="btn btn-theme-dark btn-theme-dark"><span class="glyphicon glyphicon-briefcase"></span>Wallet</a>
                                    </div>
                                    <div class="col-sm-2">
...
<p class="sel-pack-btn-wrap">
                           <a href="#" class="btn btn-theme my-recharge-select">Recharge Now</a>
                        </p>
                        <!-- Rechargeages ends -->
                        
                           
                             
                                 <div class="col-md-12 my-recharge-select-cont" style="display:none;">
                                    <div id="" class="silver-Recharge animated swing visible" data-animation="swing" data-animation-delay="600">
                                       <div class="pricing-table text-center">
                                          
                                          <!-- Plan Features  -->
                                          <div class="text-center">
                                          <!-- Table Header  -->
                                          <h3>some thing will come about Recharge.</h3>
                                          <p>some thing will come about Recharge.
                        ...
                        <div class="panel panel-info">
                           <div class="panel-heading">
                              <div class="panel-title">My Recharge</div>
                           </div>
                           <div class="panel-body">
                              <!-- My Recharge filters stats -->
                              <div class="row">
                                 <div class="col-sm-5">										
                                    <input type="text" placeholder="Recharge From Date" id="Recharge-from-date" class="form-control date-pic hasDatepicker">
                                 </div>
                                 <div class="col-sm-5">
                                    <input type="text" placeholder="Recharge To Date" id="Recharge-to-date" class="form-control date-pic hasDatepicker">
                                 </div>
                              ...
                              <!-- My Packages filters ends -->
                              <div class="row my-package-inner">
                                 <table class="table table-hover pack-table table-responsive">
                                    <thead>
                                       <tr>
                                          <th>SNo</th>                                          
                                          <th>invoice #</th>
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td>
                                             <ul class="features">
                                                <li><span class="val-start-date">01-01-2016</span></li>
                                             </ul>
                                          </td>
                                          <td>10</td>  
                                       </tr>
