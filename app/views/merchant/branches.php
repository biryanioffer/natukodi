                ...
                <div class="panel-body">
                    ...
                    <div class="branch-wrap">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom"
                                       title="" id="new-loc-title" placeholder="Chandana Brothers (Koti)"
                                       data-original-title="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="land-phone-number"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="Address1"
                                       placeholder="Ex: Sri Taruni Stores">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="Address2"
                                       placeholder="Ex: Opposite Image Hospital">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group store-cta">
                            <a href="#" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="bottom"
                    ...
                    <div class="store-view-tbl">
                        <table class="table table-hover table-responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-warning btn-sm store-existed-loc-edit-btn"
                                       data-target="#myModala" rel="tooltip" data-toggle="modal" data-placement="bottom"
                                       title="" data-original-title="Edit Store / Branches">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                </td>
                                <td>
                                    <a href="#" class="btn btn-danger btn-sm" data-toggle="tooltip"
                                       data-placement="bottom" title="" data-original-title="Delete Store / Branches">
