                           ...
                           <div id="collapse1" class="panel-collapse collapse in">
                              <div class="panel-body">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                       <a id="" href="storepackages.php" class="btn btn-theme btn-theme-block"><span class="glyphicon glyphicon-briefcase"></span>Packages</a>
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-2">
                                       <a id="" href="changePassword.php" class="btn btn-theme-dark btn-theme-dark"><span class="glyphicon glyphicon-lock"></span>Change Password</a>
                                    </div>
                                    <div class="col-sm-2">
