                           ...
                           <div id="collapse1" class="panel-collapse collapse in">
                              <div class="panel-body">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                       <a id="" href="wallet" class="btn btn-theme btn-theme-block"><span class="glyphicon glyphicon-briefcase"></span>Packages</a>
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-2">
                                       <a id="" href="#" class="btn btn-theme-dark btn-theme-dark"><span class="glyphicon glyphicon-lock"></span>Change Password</a>
                                    </div>
                                    <div class="col-sm-2">
                  ...
                  <div class="panel-body">
                     <form id="" class="form-horizontal user-password-edit" role="form" method="POST" style="">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6">
                              <input type="password" class="form-control required password" id="current_password" name="current_password" value="" minlength="5" maxlength="15">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6">
                              <input type="password" class="form-control required password" id="new_password" name="new_password" value="" minlength="5" maxlength="15">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6">
                              <input type="password" class="form-control required password" id="c_new_password" name="c_new_password" value="" minlength="5" maxlength="15" equalto="#new_password">
                              <span style="color:red;" id="c_new_password_div"></span>
                           </div>
                        </div>
                        <div class="col-md-offset-4 col-md-8">											
                           <button id="signup-verification-pop-btn" type="submit" class="btn btn-theme change_pass_btn"><i class="icon-hand-right"></i>Save</button>
