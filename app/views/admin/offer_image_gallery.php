                                ...
                                <div class="col-sm-6 hidden-xs">
                                    <div class="header-section">
                                        <ul class="breadcrumb breadcrumb-top">
                                            ...
                                            <li><a href="">Offer Image Gallery</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>OFFER NAME</th>
                                            <th class="text-center" style="width: 50px;">IMAGE URL</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">www.google.com</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>Clearance Sale</strong></td>
                                            <td class="text-center">www.google.co.in</td>
                                            <td class="text-center">25/04/2016</td>
                                            <td class="text-center">
                                                <a href="javascript:void(0)" data-toggle="tooltip" title="Edit User" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                                <a href="javascript:void(0)" data-toggle="tooltip" title="Delete User" class="btn btn-effect-ripple btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                            </td>
