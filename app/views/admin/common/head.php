...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo site_url('admin/img/favicon.png')?>">
        <link rel="apple-touch-icon" href="<?php echo site_url('admin/img/icon57.png')?>" sizes="57x57">
        <link rel="apple-touch-icon" href="<?php echo site_url('admin/img/icon72.png')?>" sizes="72x72">
        <link rel="apple-touch-icon" href="<?php echo site_url('admin/img/icon76.png')?>" sizes="76x76">
        <link rel="apple-touch-icon" href="<?php echo site_url('admin/img/icon114.png')?>" sizes="114x114">
        <link rel="apple-touch-icon" href="<?php echo site_url('admin/img/icon120.png')?>" sizes="120x120">
        <link rel="apple-touch-icon" href="<?php echo site_url('admin/img/icon144.png')?>" sizes="144x144">
        <link rel="apple-touch-icon" href="<?php echo site_url('admin/img/icon152.png')?>" sizes="152x152">
        <link rel="apple-touch-icon" href="<?php echo site_url('admin/img/icon180.png')?>" sizes="180x180">
        <!-- END Icons -->
        ...
        <link rel="stylesheet" href="<?php echo site_url('admin/css/plugins.css');?>">
        ...
        <link rel="stylesheet" href="<?php echo site_url('admin/css/themes.css');?>">
        <!-- END Stylesheets -->

        <!-- Modernizr (browser feature detection library) -->
        <script src="<?php echo site_url('admin/js/vendor/modernizr-2.8.3.min.js');?>"></script>
    </head>
    <body>
        <!-- Page Wrapper -->
