            ...
            <ul class="sidebar-nav">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="sub_categories">Sub Categories</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="user_likes">User Likes</a>
                        </li>
                        <li>
                            <a href="user_ratings">User Ratings</a>
                        </li>
                        <li>
                            <a href="user_favourites">User Favourites</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="merchant_branches">Merchant Branches</a>
                        </li>
                        <li>
                            <a href="merchant_business_categories">Merchant Business Categories</a>
                        </li>
                        <li>
                            <a href="merchant_notifications">Merchant Notifications</a>
                        </li>
                        <li>
                            <a href="merchant_transactions">Merchant Transactions</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="offer_sub_categories">Offer Sub Categories</a>
                        </li>
                        <li>
                            <a href="offer_image_gallery">Offer Image Gallery</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-separator">
