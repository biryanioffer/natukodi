                        ...
                        <div class="panel panel-default">
                           ...
                           <div id="collapse1" class="panel-collapse collapse in">
                              <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-2">										
                                       <a id="" href="profile" class="btn btn-theme-dark btn-theme-dark" ><span class="glyphicon glyphicon-user"></span>Profile </a>
                                    </div>
               ...
               <div class="panel-body" >
                  <form id="signupform" class="form-horizontal" role="form">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <input type="text" class="form-control" id="first-name" disabled placeholder="Subbu">
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="last-name" class="col-md-4 control-label">*Last Name</label>
                        <div class="col-md-6">
                           <input type="text" class="form-control" id="last-name" disabled placeholder="Pedagadi">
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="create-user-name" class="col-md-4 control-label">*Email</label>
                        <div class="col-md-6">
                           <input type="email" class="form-control" id="create-user-name" disabled placeholder="subbu.ped@gmail.com">
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                           <input type="text" class="form-control date-pic" id="dob" disabled placeholder="02/02/1981">
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-offset-4 col-md-8">
                           <a href="thank_you" id="btn-signup" type="submit" class="btn btn-info"><i class="icon-hand-right"></i>Update</a>
                        </div>
                     </div>
                  </form>
               </div>
