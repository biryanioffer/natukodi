        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2">
            ...
            <div class="panel panel-info" id="forgot-credentials-form-panel">
                ...
                <div class="panel-body">
                    ...
                    <form id="forgot-credentials-form" class="form-horizontal" role="form" method="post" action="<?php echo base_url() ?>index.php/console/forgotpassword">
						...
						<div class="form-group forgot-cre">
                            ...
                            <div class="col-xs-9">
                                ...
                                <input type="email" class="form-control" id="contact-email" placeholder="Enter Email" name="emailid" required>
