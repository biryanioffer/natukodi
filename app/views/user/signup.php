				   ...
				   <form id="userSignUpFrm" class="form-horizontal" role="form" method="POST" action="<?php echo base_url()?>index.php/console/usersave">
                     <div id="signupalert" style="display:none" class="alert alert-danger">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <select id="user_title"  name="user_title" required  class="selectpicker" data-live-search="true">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <input type="password" class="form-control" name="cpassword" id="cpassword" required  placeholder="Retype Password">
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="phone-number" class="col-md-4 control-label">*Phone Number</label>
                        <div class="col-md-6">
                           <input type="text" class="form-control" name="contact_number" id="contact_number" required  placeholder="Enter Phone Number">
                        </div>
                     </div>
                     <div class="form-group">
