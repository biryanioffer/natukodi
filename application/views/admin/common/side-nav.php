                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/administrators">Administrators</a>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="http://localhost/0fferc1t1/index.php/admin/categories">Main Categories</a>
                                                </li>
                                                <li>
                                                    <a href="http://localhost/0fferc1t1/index.php/admin/sub_categories">Sub Categories</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/service_areas">Service Areas</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/users">Users</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/user_likes">User Likes</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/user_ratings">User Ratings</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/user_favourites">User Favourites</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/merchants">Merchants</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/merchant_branches">Merchant Branches</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/merchant_business_categories">Merchant Business Categories</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/merchant_notifications">Merchant Notifications</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/merchant_transactions">Merchant Transactions</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/offers">Offers</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/offer_sub_categories">Offer Sub Categories</a>
                                        </li>
                                        <li>
                                            <a href="http://localhost/0fferc1t1/index.php/admin/offer_image_gallery">Offer Image Gallery</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="sidebar-separator">
